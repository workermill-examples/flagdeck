	...
	<div class="flex justify-between items-center">
		<div>
			...
			<p class="text-gray-600 mt-1">
				Manage your application's feature flags and their deployment configurations
			</p>
		</div>
		<a
			href="/flags/create"
	...
	<div class="bg-white shadow rounded-lg p-4">
		<div class="grid grid-cols-1 md:grid-cols-4 gap-4">
			...
			<div class="flex items-end">
				<button
					onclick={() => { searchQuery = ''; selectedType = ''; selectedTag = ''; }}
	...
	{:else if filteredFlags.length === 0}
		...
		<div class="text-center py-12">
			<svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.586a1 1 0 01.707.293l2.414 2.414a1 1 0 01.293.707V13a2 2 0 01-2 2H5a2 2 0 01-2 2z" />
			</svg>
