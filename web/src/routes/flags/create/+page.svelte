      ...
      <div class="bg-white shadow rounded-lg p-6 space-y-6">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            {/if}
            <p class="text-xs text-gray-500 mt-1">
              This value will be used when the flag is disabled or no targeting
              rules match
            </p>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <p class="text-sm text-gray-600">
            The flag will be created enabled in all environments with 100%
            rollout. You can adjust individual environment settings after
            creation.
          </p>
